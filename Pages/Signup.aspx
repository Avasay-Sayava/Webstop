  ...
  <div class="container right-panel-active" id="container">
    <div class="form-container sign-up-container">
      ...
      <form action="Signup" method="post" id="up">
        ...
        <label for="up-password">Invalid password. Your password must contain at least eight characters (up to 16), one number, lowercase and uppercase letters, and a special character.</label>
